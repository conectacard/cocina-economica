...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=U9uRWXZjHlE",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "Nacimos con una sola misión: ¡Darte el mejor servicio para que disfrutes diariamente de un menú diferentes y sabroso! Nos encanta consentirte con nuestras recetas originales, ingredientes frescos y especialidades preparadas al momento." },
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "En nuestras sucursales te damos un servicio de la mejor calidad en alimentos de calidad, con un menu diferente cada dia." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestros clientes, tanto locales como los que nos visitan de fuera, nos eligen y recomidan por nuestra gran calidad, servico, profesionalismo y precio, reconociendo la tradición en cada una de nuestras sucursales" }
    },
    sucursales: {
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/-cJCPDHfbB8" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
